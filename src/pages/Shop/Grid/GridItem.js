		...
		<motion.div className="column" whileHover="hover">
			<div className="is-relative is-clipped">
				<Link
					...
					className="figure-black-gradient is-absolute"></Link>
				<div className="is-absolute is-size-4 has-text-weight-bold m-3  has-text-white">{title}</div>
				<motion.figure
					variants={zoomVariants}
					className={"image  bg-img " + figClass}
					style={{ backgroundImage: `url(${img})` }}></motion.figure>
			</div>
		</motion.div>
	);
};
